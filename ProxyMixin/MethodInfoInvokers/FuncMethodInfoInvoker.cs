...
{
	public sealed class FuncMethodInfoInvoker<T, TResult> : MethodInfoInvoker<T>
	{
		public FuncMethodInfoInvoker(MethodInfo methodInfo)
			: base(methodInfo)
		{
		}
	...
	public sealed class FuncMethodInfoInvoker<T, T1, TResult> : MethodInfoInvoker<T, T1>
	{
		public FuncMethodInfoInvoker(MethodInfo methodInfo)
			: base(methodInfo)
		{
	...
	public sealed class FuncMethodInfoInvoker<T, T1, T2, TResult> : MethodInfoInvoker<T, T1, T2>
	{
		public FuncMethodInfoInvoker(MethodInfo methodInfo)
			: base(methodInfo)
		{
	...
	public sealed class FuncMethodInfoInvoker<T, T1, T2, T3, TResult> : MethodInfoInvoker<T, T1, T2, T3>
	{
		public FuncMethodInfoInvoker(MethodInfo methodInfo)
			: base(methodInfo)
		{
	...
	public sealed class FuncMethodInfoInvoker<T, T1, T2, T3, T4, TResult> : MethodInfoInvoker<T, T1, T2, T3, T4>
	{
		public FuncMethodInfoInvoker(MethodInfo methodInfo)
			: base(methodInfo)
		{
	...
	public sealed class FuncMethodInfoInvoker<T, T1, T2, T3, T4, T5, TResult> : MethodInfoInvoker<T, T1, T2, T3, T4, T5>
	{
		public FuncMethodInfoInvoker(MethodInfo methodInfo)
			: base(methodInfo)
		{
	...
	public sealed class FuncMethodInfoInvoker<T, T1, T2, T3, T4, T5, T6, TResult> : MethodInfoInvoker<T, T1, T2, T3, T4, T5, T6>
	{
		public FuncMethodInfoInvoker(MethodInfo methodInfo)
			: base(methodInfo)
		{
	...
	public sealed class FuncMethodInfoInvoker<T, T1, T2, T3, T4, T5, T6, T7, TResult> : MethodInfoInvoker<T, T1, T2, T3, T4, T5, T6, T7>
	{
		public FuncMethodInfoInvoker(MethodInfo methodInfo)
			: base(methodInfo)
		{
	...
	public sealed class FuncMethodInfoInvoker<T, T1, T2, T3, T4, T5, T6, T7, T8, TResult> : MethodInfoInvoker<T, T1, T2, T3, T4, T5, T6, T7, T8>
	{
		public FuncMethodInfoInvoker(MethodInfo methodInfo)
			: base(methodInfo)
		{
	...
	public sealed class FuncMethodInfoInvoker<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> : MethodInfoInvoker<T, T1, T2, T3, T4, T5, T6, T7, T8, T9>
	{
		public FuncMethodInfoInvoker(MethodInfo methodInfo)
			: base(methodInfo)
		{
