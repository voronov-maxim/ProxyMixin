...
namespace ProxyMixin.MethodInfoInvokers
{
    ...
    public interface IMethodInfoInvokerParameters<out T, out T1, out T2, out T3, out T4, out T5, out T6, out T7, out T8, out T9>
    {
        T Target
        {
            get;
    ...
    public sealed class MethodInfoInvokerParameters<T, T1, T2, T3, T4, T5, T6, T7, T8, T9> :
        IMethodInfoInvokerParameters<T, T1, T2, T3, T4, T5, T6, T7, T8, T9>, IMethodInfoInvokerParameters
    {
